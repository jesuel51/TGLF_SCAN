...
base_loadOutputs={'out.tglf.run':OMFITgaCode,'out.tglf.wavefunction':OMFITgaCode,'run_log':OMFITgaCode}
...
for para_val in para_rang:
    ...
    inputs_node['input.tglf']['USE_TRANSPORT_MODEL']=False
    for ky in kyarr:
#        print('ky=',ky)
        new_dir=para_name+'~'+str(para_val)+'~ky~'+str(ky)[0:4]  # here we only retains 4 effective number for defining the ky
